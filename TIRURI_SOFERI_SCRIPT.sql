...
ALTER TABLE SOFERI_TIRURI
ADD DATA_INCEPUT DATE;

ALTER TABLE SOFERI_TIRURI
ADD DATA_SFARSIT DATE;
...
CREATE TABLE DATE_RAPORT
(
ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),
NUME_RAPORT VARCHAR(255) NOT NULL,
UTLIZATOR INTEGER NOT NULL,
DATA_SUBMIT TIMESTAMP NOT NULL,
DATA_GENERARE TIMESTAMP,
STARE VARCHAR(255) NOT NULL,
REPORT_PATH VARCHAR(255) NOT NULL,
)

ALTER TABLE DATE_RAPORT ADD FOREIGN KEY(UTILIZATOR) REFERENCES UTILIZATORI(ID);
...
ALTER TABLE SOFERI_TIRURI
ADD IN_CURSA BOOLEAN DEFAULT FALSE;

ALTER TABLE INREGISTRARI
ALTER COLUMN DATA_SOSIRE NULL;
